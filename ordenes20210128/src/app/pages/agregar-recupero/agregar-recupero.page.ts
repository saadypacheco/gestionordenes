...
import { AgregarRecuperoFormPage } from '../agregar-recupero-form/agregar-recupero-form.page';
...
@Component({
  ...
  templateUrl: './agregar-recupero.page.html',
  styleUrls: ['./agregar-recupero.page.scss'],
})
export class AgregarRecuperoPage implements OnInit {
